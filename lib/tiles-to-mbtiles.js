...
const TTM_REQ_PER_SECOND = parseInt(process.env.TTM_REQ_PER_SECOND) || 20;
const TTM_MAX_THREADS = parseInt(process.env.TTM_MAX_THREADS) || 3;

const limiter = new RateLimiter(TTM_REQ_PER_SECOND, 'second');
